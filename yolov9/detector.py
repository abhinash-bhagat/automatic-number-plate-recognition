...
# Define the function to perform OCR on an image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        text_file_path = save_dir / f'{p.stem}_text.txt'
                        with open(text_file_path, 'w') as text_file:
                            text_file.write(text_ocr)

                        annotator.box_label(xyxy, text_ocr, color=colors(c, True))  # Display text instead of label
